<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #C0392B;"><b>INTERNS BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="transfermoney.php" style="color : #C0392B;"><b>View All Users</b></a>
              </li>
              <li class="nav-item">
